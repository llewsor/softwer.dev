...
const services = [
  {
    ...
    description: "Reliable web applications for operations, customer portals, booking systems, inventory, reporting, and team workflows.",
  },
  {
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-normal text-zinc-950 dark:text-white md:text-4xl">End-to-end software delivery without the full-time product team overhead.</h2>
          <p className="mt-5 text-lg leading-8 text-zinc-700 dark:text-zinc-300">
            We handle strategy, design, engineering, deployment, and support so the software is useful in the business, not just impressive in a demo.
          </p>
        </div>
