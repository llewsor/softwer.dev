...
const Contact = () => {
  ...
  return (
    <motion.section
      ...
      className="bg-zinc-900 px-4 py-20 text-white lg:px-6"
      id="contact"
    >
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
        ...
        <form
          ...
          className="rounded-lg border border-zinc-800 bg-white p-6 text-left text-zinc-950 shadow-xl dark:bg-zinc-900 dark:text-white"
        >
