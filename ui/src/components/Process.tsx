      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-normal text-zinc-950 dark:text-white md:text-4xl">
            Predictable delivery for software your business depends on.
          </h2>
        </div>
        <div className="mt-12 grid gap-4 lg:grid-cols-5">
          {steps.map(([number, title, description]) => (
            <div key={number} className="rounded-lg border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
